    ...
    <div className="bg-white/90 backdrop-blur-md shadow-2xl rounded-2xl p-8 border border-purple-200 flex flex-col justify-between gap-8">
      ...
      <div>
        ...
        <ul className="list-disc pl-5 text-sm text-gray-700 space-y-2">
          <li>Select the correct Crypto type before uploading.</li>
      ...
      <div>
        ...
        <ol className="list-decimal pl-5 text-sm text-gray-700 space-y-2">
          <li>Select your Crypto type (e.g., iTunes, Amazon, Steam, etc).</li>
      ...
      <div className="bg-purple-50 border-l-4 border-green-800 p-4 rounded-lg text-sm text-gray-700">
        🔒 <strong>Security Notice:</strong> Your Crypto redemption is encrypted and manually verified to prevent fraud.
      </div>

      {/* Support */}
      <div className="text-sm text-gray-600">
        Having issues? Contact support at{" "}
        <a href="mailto:useMonetrax@gmail.com" className="text-green-800 font-medium underline">
          useMonetrax@gmail.com
        </a>
      </div>
