...
5. WALLET TOP-UP & PLAN ACTIVATION: Users can add money to their wallet by going to Dashboard → Fund Wallet. They can pay securely via Card (instant credit, minimum ₦100). Once funded, they go to Dashboard → Billing to select and activate any plan (Starter ₦15k, Business ₦45k, Enterprise ₦120k). An automated email receipt is sent after every wallet top-up and plan activation.
