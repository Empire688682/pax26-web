...
const SCENARIOS = [
  ...
  },
  {
    ...
    points: [
      "AI collects product interest and order size",
      "Scores the lead before human sees it",
      "Routes hot leads to sales team instantly",
    ],
    messages: [
      { from: "user", text: "Hi, I want to place a bulk order for my restaurant", t: 0 },
      { from: "bot", text: "Welcome! \uD83D\uDE80 What are you looking to order?\n\n1\uFE0F\u20E3 Food packaging\n2\uFE0F\u20E3 Kitchen equipment\n3\uFE0F\u20E3 Custom supply order", t: 900 },
      { from: "user", text: "Custom supply order for a big event", t: 2400 },
      { from: "bot", text: "Got it. How many guests are you expecting?", t: 3300 },
      { from: "user", text: "Around 300 people", t: 4700 },
      { from: "bot", text: "You qualify for our corporate package \uD83D\uDCBC\n\nConnecting you with our sales team now — they'll reach you in under 5 mins!", t: 5700 },
    ],
  },
];
