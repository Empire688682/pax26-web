                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  <div style={{ display: "flex", gap: "10px" }}>
                      ...
                      <div style={{ flex: 1 }}>
                        {cartQuantity > 0 ? (
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", borderRadius: "14px", background: t.card, border: `2px solid ${t.accent}` }}>
                            <span style={{ fontSize: "13px", fontWeight: 700, color: t.textPrimary }}>In Cart:</span>
                            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                              <button onClick={() => cartState.setItemQuantity(product._id, cartQuantity - 1)} style={{ width: "28px", height: "28px", borderRadius: "6px", background: t.pageBg, border: `1px solid ${t.border}`, color: t.textPrimary, cursor: "pointer", fontWeight: 800 }}>-</button>
                          ...
                          <button
                            ...
                            style={{ width: "100%", padding: "16px", borderRadius: "14px", background: t.accent, color: t.accentText, fontWeight: 800, fontSize: "15px", border: "none", cursor: "pointer", boxShadow: "0 4px 14px rgba(0,0,0,0.15)" }}
                          >
                            + Add to Cart
                          </button>
                        )}
                    ...
                    <a href={isOutOfStock ? undefined : whatsappHref} onClick={(e) => !isOutOfStock && handleWhatsAppRedirect(e, whatsappHref)} target={isOutOfStock ? undefined : "_blank"} rel="noopener noreferrer"
                      style={{ flex: 1.2, display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "16px 20px", borderRadius: "14px", background: isOutOfStock ? t.border : "#25d366", color: isOutOfStock ? t.textSecondary : "#fff", fontWeight: 800, fontSize: "15px", textDecoration: "none", cursor: isOutOfStock ? "not-allowed" : "pointer", boxShadow: isOutOfStock ? "none" : "0 6px 20px #25d36640", pointerEvents: isOutOfStock ? "none" : "auto" }}>
                      <WhatsAppIcon />{isOutOfStock ? "Out of Stock" : "Buy This Item"}
                    </a>
                  </div>

                  {cartState.totalQuantity > 0 && (
                    <Link href={`/store/${slug}`} style={{ fontSize: "13px", fontWeight: 700, color: t.accent, textAlign: "center", textDecoration: "none", padding: "6px" }}>
